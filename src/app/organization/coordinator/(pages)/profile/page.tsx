...
function InfoTile({
  ...
  return (
    <div
      className={`rounded-xl border ${colorMap[color]} p-4 flex items-center gap-3`}
    >
      <div
...
export default function CoordinatorProfilePage() {
  ...
  const inputClass =
    "w-full px-4 py-3 bg-[#0f172a] border border-slate-700/50 rounded-xl text-sm text-white placeholder:text-slate-600 focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/30 transition-all";
  ...
  return (
    <div className="min-h-screen w-full bg-[#030712] text-slate-200 font-sans selection:bg-purple-500/30 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div
          className="absolute top-[-15%] right-[-5%] w-[500px] h-[500px] bg-purple-500/8 rounded-full blur-[120px] animate-pulse"
          style={{ animationDuration: "8s" }}
        />
        <div
          className="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] bg-pink-500/6 rounded-full blur-[100px] animate-pulse"
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-8 pb-20">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-2 mb-2">
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-purple-500/15 text-purple-300 text-[11px] font-bold uppercase tracking-wider border border-purple-500/20 backdrop-blur-md">
                  ...
                  {DESIGNATION_LABELS[readOnly.designation] ||
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl bg-[#111827] border border-white/5 p-4">
            ...
            <div className="flex gap-2">
              <input
                ...
                name="profilePhoto"
                value={
                  form.profilePhoto.startsWith("data:") ? "" : form.profilePhoto
                }
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="px-4 py-3 bg-[#0a0f1a] border border-slate-800/50 rounded-xl text-sm text-slate-400 flex items-center gap-2">
                  ...
                  <span className="ml-auto text-[10px] text-slate-600 border border-slate-700 rounded-md px-2 py-0.5">
                    Read-only
                  </span>
                </div>
                <p className="text-[10px] text-slate-600 mt-1">
                  Email cannot be changed. Contact your organization admin.
                </p>
              </div>
            </div>
          </SectionCard>
          ...
          <SectionCard
            icon={FileText}
            title="About / Bio"
            subtitle="A short introduction about yourself (max 500 characters)"
            accentColor="pink"
          >
            <div>
              <textarea
              ...
              <div className="flex justify-between mt-1.5">
                ...
                <p
                  className={`text-[10px] ${form.bio.length > 450 ? "text-amber-400" : "text-slate-600"}`}
                >
                  {form.bio.length}/500
                </p>
              </div>
          ...
          <SectionCard
            ...
            subtitle="Your assigned department and parent organization"
            accentColor="blue"
          >
          ...
          <SectionCard
            ...
            subtitle="Security and authentication information"
            accentColor="emerald"
          >
            <div className="space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <ReadOnlyField
                  ...
                  value={
                    readOnly.createdAt
                      ? new Date(readOnly.createdAt).toLocaleDateString(
                          "en-US",
                          {
                            month: "long",
                            day: "numeric",
              ...
              <div className="flex items-center gap-3 pt-1">
                <StatusBadge
                  active={readOnly.isVerified}
                  label={
                    readOnly.isVerified ? "Email Verified" : "Email Unverified"
                  }
                />
                <StatusBadge
                  active={readOnly.isActive}
                  label={
                    readOnly.isActive ? "Account Active" : "Account Inactive"
                  }
                />
              </div>
            </div>
