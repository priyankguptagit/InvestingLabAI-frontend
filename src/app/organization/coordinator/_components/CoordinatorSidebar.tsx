    ...
    return (
      <div className="h-[88px] flex items-center px-6 border-b border-white/5 relative shrink-0">
        <div
          ...
          className={cn(
            "flex items-center gap-4 w-full transition-all duration-300 group/header",
            !isOpen && "cursor-pointer justify-center",
          )}
        >
          <div className="relative">
            ...
            <Image
              ...
              width={44}
              height={44}
              className="relative rounded-2xl group-hover/header:scale-105 transition-transform duration-300"
            />
          </div>
          ...
          >
            ...
            <span
              className="text-[10px] font-bold text-purple-400 tracking-[0.1em] mt-1 whitespace-nowrap uppercase truncate max-w-[140px]"
              title={deptName}
            >
              {deptName}
            </span>
        ...
        {isOpen && (
          ...
          >
            <ChevronLeft
              size={14}
              className="group-hover/toggle:-translate-x-0.5 transition-transform"
            />
          </button>
        )}
      </div>
        ...
        >
          ...
          <div
            className={cn(
              ...
              isActive || isSubActive
                ? "text-purple-400 drop-shadow-[0_0_8px_rgba(192,132,252,0.5)] scale-105"
          ...
          <div
            className={cn(
              "flex-1 text-left ml-3 transition-all duration-300 overflow-hidden whitespace-nowrap",
              isOpen ? "w-auto opacity-100" : "w-0 opacity-0 ml-0",
            )}
          >
            <span
              className={cn(
                (isActive || isSubActive) && "font-semibold tracking-wide",
              )}
            >
              {item.label}
            </span>
...
const UserProfileFooter = memo(
  ({ isOpen, user }: { isOpen: boolean; user: any }) => {
...
export default function CoordinatorSidebar() {
  ...
  const [coordData, setCoordData] = useState({
    ...
    email: "Loading...",
    dept: "Department",
    // profilePhoto from DepartmentCoordinatorModel — isolated from UserModel
    ...
    try {
      ...
      if (cData.success && cData.coordinator) {
        setCoordData({
          ...
          avatar: cData.coordinator.profilePhoto || null,
        });
      }
  ...
  const MENU_GROUPS: MenuGroup[] = [
    {
      ...
      items: [
        {
          href: "/organization/coordinator/dashboard",
          label: "Dashboard",
    ...
    },
    {
      ...
      items: [
        {
          href: "/organization/coordinator/profile",
          label: "My Profile",
          icon: Users,
        },
      ],
          ...
          <div
            className={cn(
              ...
              isOpen
                ...
                : "opacity-0 translate-y-8 pointer-events-none absolute bottom-0",
            )}
          >
            <StatusCard />
          </div>
