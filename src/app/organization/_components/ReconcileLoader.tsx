...
export function ReconcileLoader({
  isReconciling,
  text = "Reconciling Reports...",
}: ReconcileLoaderProps) {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <div
            className="w-32 h-32 rounded-full border-2 border-indigo-500/30 border-t-indigo-500 animate-spin"
            style={{ animationDuration: "3s" }}
          />
        </div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <div
            className="w-40 h-40 rounded-full border-2 border-purple-500/20 border-b-purple-500 animate-spin"
        ...
        <div className="bg-[#0F172A]/80 border border-white/10 px-8 py-4 rounded-full shadow-xl shadow-black/50 backdrop-blur-md">
          ...
          <p className="text-xs text-slate-400 text-center mt-2 font-medium">
            Please wait while AI analyzes portfolios
          </p>
        </div>
      </div>
    </div>
