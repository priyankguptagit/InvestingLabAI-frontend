  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white selection:bg-indigo-500/30 overflow-x-hidden font-sans pb-20">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div
          className="absolute bottom-0 right-1/4 w-96 h-96 bg-fuchsia-600/20 rounded-full blur-[128px] animate-pulse"
      ...
      <div className="relative mt-[72px] w-full bg-black/40 border-b border-white/5 flex flex-col select-none overflow-hidden py-2 z-20">
        ...
        <div className="h-7 flex items-center relative overflow-hidden border-b border-white/[0.03] mb-1">
          ...
          <div
            className="animate-marquee-dynamic-reverse hover:[animation-play-state:paused] flex items-center gap-12 whitespace-nowrap pl-32 pr-4"
            style={
              {
                "--duration": `${niftyStocks.length * 5}s`,
              } as React.CSSProperties
            }
          >
            {(niftyStocks.length > 0
              ...
              <div key={idx} className="flex items-center gap-4">
                ...
                <span className="text-[11px] font-mono font-bold text-white transition-all duration-1000">
                  ₹{item.price.toFixed(2)}
                </span>
                <span
                  className={`text-[10px] font-bold flex items-center gap-1 ${item.change >= 0 ? "text-emerald-400" : "text-rose-400"}`}
                >
        ...
        <div className="h-7 flex items-center relative overflow-hidden">
          ...
          <div
            className="animate-marquee-dynamic hover:[animation-play-state:paused] flex items-center gap-12 whitespace-nowrap pl-32 pr-4"
            style={
              {
                "--duration": `${etfStocks.length * 5}s`,
              } as React.CSSProperties
            }
          >
            {(etfStocks.length > 0 ? [...etfStocks, ...etfStocks] : []).map(
              (item, idx) => (
                <div key={idx} className="flex items-center gap-4">
                  <span className="text-[10px] font-bold text-slate-400 uppercase">
                    {item.symbol}
                  </span>
                  <span className="text-[11px] font-mono font-bold text-slate-200 transition-all duration-1000">
                    ₹{item.price.toFixed(2)}
                  </span>
                  <span
                    className={`text-[10px] font-bold flex items-center gap-1 ${item.change >= 0 ? "text-emerald-400/80" : "text-rose-400/80"}`}
                  >
                    {item.change >= 0 ? "▲" : "▼"}{" "}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            <h1 className="text-3xl md:text-5xl lg:text-7xl font-black tracking-tight leading-tight text-white animate-in fade-in slide-in-from-bottom-8 duration-1000">
              The Future of{" "}
              <span className="text-indigo-500">Stock Market Intelligence</span>
            </h1>
            <p className="max-w-2xl mx-auto text-lg md:text-xl text-slate-400 mb-10 leading-relaxed animate-in fade-in slide-in-from-bottom-10 duration-1000 font-medium">
              Experience the next generation of financial research. Beautifully
              designed, highly performant, and institutional-grade analytics for
              everyone.
            </p>
          </div>
          ...
          {/* VIDEO SHOWCASE */}
          <div
            className="mt-12 relative mx-auto max-w-4xl animate-reveal"
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Why Choose <span className="text-indigo-500">Praedico?</span>
            </h2>
            <p className="text-slate-400 max-w-xl mx-auto">
              Our platform provides comprehensive solutions for modern traders,
              ensuring institutional-grade accuracy and speed.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <FeatureCard
              ...
              desc="Real-time insights from NSE and international exchanges delivered in milliseconds."
              delay="0s"
            />
            <FeatureCard
              icon={Lock}
              color="text-fuchsia-400"
              bg="from-fuchsia-500/20 to-pink-500/5"
              title="Institutional Security"
              desc="Bank-grade encryption and security protocols protecting your research and data."
              delay="0.1s"
            />
            <FeatureCard
              icon={Smartphone}
              ...
              desc="Access pro-level signals and market trackers on any device with our optimized web app."
              delay="0.2s"
            />
          </div>
        </div>
      ...
      <section className="py-24 bg-[#020617] relative overflow-hidden border-t border-white/5">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Our Platform <span className="text-indigo-500">Statistics</span>
            </h2>
            <p className="text-slate-400 max-w-xl mx-auto">
              Empowering transparency and institutional accuracy at scale for
              every trader.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 max-w-5xl mx-auto">
            <StatCard
              icon={Building2}
              label="Partnered Organizations"
              value="500+"
              desc="Global enterprise partners"
              delay="0s"
              color="text-blue-400"
              bg="from-blue-500/20 to-cyan-500/5"
            />
            ...
            <StatCard
              ...
              value="1.2M+"
              desc="Trusted by retail traders"
              delay="0.2s"
              color="text-indigo-400"
              bg="from-indigo-500/20 to-purple-500/5"
            />
            <StatCard
              icon={Activity}
              label="Active Users"
              value="850K+"
              desc="Monthly active members"
              delay="0.3s"
      ...
      <section className="py-24 bg-[#020617] relative overflow-hidden border-t border-white/5">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Our Approved <span className="text-indigo-500">Partners</span>
            </h2>
            <p className="text-slate-400 max-w-xl mx-auto mb-8">
              Collaborating with the world&apos;s most innovative financial
              entities and institutional researchers.
            </p>
            <Button
              ...
              <div className="overflow-hidden">
                ...
                >
                  {[0, 1, 2, 3].map((page) => (
                    <div
                      key={page}
                      className="w-full flex-shrink-0 grid grid-cols-2 md:grid-cols-4 gap-6"
                    >
                      {[1, 2, 3, 4].map((i) => (
                        <div
                          key={i}
          ...
          <div className="max-w-4xl mx-auto relative group">
            ...
            <div className="relative rounded-[2rem] bg-slate-950/80 border border-white/10 p-10 md:p-16 text-center backdrop-blur-xl overflow-hidden shadow-2xl flex flex-col items-center">
              ...
              <p className="text-base md:text-lg text-slate-300 mb-10 max-w-lg mx-auto font-medium relative z-10 leading-relaxed">
                Join thousands of smart investors building their wealth with
                InvestingLab AI today.
              </p>
...
function FeatureCard({ icon: Icon, title, desc, delay, color, bg }: any) {
  return (
    ...
    >
      <div
        className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl ${bg} rounded-bl-full opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
      />
      <CardContent className="p-0">
        <div
          className={`inline-flex p-2.5 rounded-xl bg-slate-900 border border-slate-800 mb-5 ${color}`}
        >
          <Icon className="w-5 h-5" />
        </div>
        <h3 className="text-lg font-bold mb-2 text-white group-hover:text-indigo-200 transition-colors">
          {title}
        </h3>
...
function StatCard({ icon: Icon, label, value, desc, delay, color, bg }: any) {
  return (
    ...
    >
      ...
      <CardContent className="p-0">
        <div
          className={`p-3 rounded-xl bg-slate-900 border border-white/5 inline-flex mb-5 ${color} group-hover:scale-110 transition-transform`}
        >
          <Icon className="w-6 h-6" />
        </div>
        <h4 className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-1.5">
          {label}
        </h4>
        ...
        <p className="text-slate-400 text-xs mt-3 font-medium opacity-60 group-hover:opacity-100 transition-opacity italic">
          {desc}
        </p>
      </CardContent>
    </Card>
...
function FeedbackModal({
  ...
  return (
    <div
      className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/80 backdrop-blur-md p-4 md:p-6 animate-in fade-in duration-300"
      onClick={onClose}
    >
      <div
        className="bg-[#0f172a] border border-white/10 rounded-[2rem] w-full max-w-7xl max-h-[90vh] flex flex-col shadow-2xl"
      ...
      >
        ...
        <div className="p-5 border-b border-white/10 flex flex-col md:flex-row items-center justify-between gap-3 bg-white/[0.02] rounded-t-[2rem]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-black text-white">User Feedback</h3>
              <p className="text-slate-500 text-[9px] font-black uppercase">
                {sortedData.length} verified reviews
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              size="sm"
              onClick={() =>
                setFeedbackSort(feedbackSort === "latest" ? "oldest" : "latest")
              }
            ...
            <Button
              ...
              onClick={() =>
                setFeedbackSort(
                  feedbackSort === "rating_high" ? "rating_low" : "rating_high",
                )
              }
          ...
          <table className="w-full text-left border-collapse">
            <thead className="sticky top-0 bg-[#0f172a] z-10">
              <tr className="border-b border-white/10 uppercase font-black text-slate-500 text-[9px] tracking-widest bg-[#0f172a] shadow-md shadow-indigo-900/5">
                <th className="px-8 py-5 w-[20%] font-black tracking-widest text-[#6B7280]">
                  USER
                </th>
                <th className="px-5 py-5 w-[40%] font-black tracking-widest text-[#6B7280]">
                  RATING BREAKDOWN
                </th>
                <th className="px-5 py-5 w-[15%] font-black tracking-widest text-[#6B7280]">
                  AVG RATING
                </th>
                <th className="px-5 py-5 w-[25%] font-black tracking-widest text-[#6B7280]">
                  DESCRIPTION
                </th>
              </tr>
            </thead>
              ...
              {sortedData.length === 0 ? (
                ...
                sortedData.map((item: any, i: number) => {
                  ...
                  if (item.factorRatings && Array.isArray(item.factorRatings)) {
                    item.factorRatings.forEach((f: any) => {
                      ratingMap[f.factor] = f.score;
                    });
                  }
                      ...
                      <td className="px-8 py-6 align-top">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-slate-500 text-[10px] uppercase font-semibold tracking-wide">
                              {item.role}
                            </p>
                            <p className="text-slate-600 text-[10px] font-semibold mt-1">
                              {item.date}
                            </p>
                          </div>
                        </div>
                                ...
                                <div key={fKey} className="flex flex-col">
                                  ...
                                  <div className="flex gap-0.5">
                                    {[...Array(5)].map((_, s) => (
                                      <Star
                                        key={s}
                                        className={`w-3 h-3 ${s < (score as number) ? starColor : "text-slate-800"}`}
                                      />
                                    ))}
                                  </div>
                                </div>
                          ...
                          <div>
                            ...
                            <div className="flex gap-0.5 mt-2">
                              {[...Array(5)].map((_, s) => (
                                <Star
                                  key={s}
                                  className={`w-3 h-3 ${s < Math.round(item.rating) ? "fill-yellow-400 text-yellow-400" : "text-slate-800"}`}
                                />
                              ))}
                            </div>
                          </div>
...
function PartnersModal({ isOpen, onClose }: any) {
  ...
  return (
    ...
    >
      <div
        className="bg-[#020617] border border-white/10 rounded-[2.5rem] w-full max-w-6xl max-h-[90vh] flex flex-col shadow-[0_20px_100px_rgba(79,70,229,0.3)] relative overflow-hidden mt-0"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Decorative Background Glows */}
        ...
        <div className="p-6 md:p-10 border-b border-white/10 flex flex-col md:flex-row items-center justify-between gap-8 bg-white/[0.015] relative z-10">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-slate-500 text-[11px] font-bold uppercase tracking-[0.4em] mt-3 opacity-80">
                Institutional Verified Ecosystem • Global Network
              </p>
            </div>
          </div>
          <div className="flex items-center gap-6">
        ...
        <div className="flex-1 overflow-y-auto p-8 md:p-12 relative z-10 custom-scrollbar pb-24">
          {filteredPartners.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-80 text-center">
              ...
              <h4 className="text-xl text-white font-bold mb-3 tracking-tight">
                No results found
              </h4>
              <p className="text-slate-500 text-sm max-w-sm mx-auto leading-relaxed">
                Try adjusting your search to find a specific partner or
                category.
              </p>
            </div>
          ) : (
              ...
              {filteredPartners.map((partner) => (
                ...
                >
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div>
                      <h4 className="text-white font-black text-sm tracking-tight group-hover:text-white transition-colors uppercase leading-tight">
                        {partner.name}
                      </h4>
                      <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.2em] mt-2 opacity-80 group-hover:text-slate-400">
                        {partner.category}
                      </p>
                    </div>
                  </div>
