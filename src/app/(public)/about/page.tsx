 ...
 * proposition of InvestingLab AI.
 */
      ...
      >
        <div className="max-w-3xl mx-auto space-y-4">
          ...
          >
            <Badge
              variant="outline"
              className="text-xs md:text-sm font-bold uppercase tracking-[0.5em] text-indigo-400 border-indigo-500/30 bg-indigo-500/5 px-4 py-1"
            >
          ...
          >
            <div className="space-y-4">
              <motion.div whileHover={{ scale: 1.05 }} className="inline-flex">
                <Badge
                  variant="outline"
                  className="px-3 py-1 rounded-full border-indigo-500/20 bg-indigo-500/10 text-indigo-400 text-xs font-bold uppercase tracking-widest cursor-default"
                >
                  About Us
                </Badge>
              </motion.div>
              <h3 className="text-2xl md:text-4xl font-bold tracking-tight leading-[1.2]">
                ...
                <span className="text-indigo-500">for the modern investor</span>
              </h3>
            </div>

            <div className="space-y-5 text-base md:text-lg text-slate-400 font-medium leading-relaxed">
              <p>
                Founded on the principle of institutional-grade accessibility,
                InvestingLab AI serves as the bridge between complex
                market dynamics and actionable investor intelligence. We believe
                that sophisticated research shouldn't be a privilege of the few,
                but a foundation for the many.
              </p>
              <p>
                Our background is rooted in deep quantitative analysis and
                macroeconomic strategy. By blending human expertise with
                algorithmic precision, we provide a perspective that is both
                technically rigorous and intuitively navigable, ensuring our
                partners navigate global markets with absolute clarity.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8 pt-4 border-t border-white/5">
              <div className="space-y-1">
                ...
                <p className="text-[9px] text-slate-500 uppercase tracking-[0.2em] font-extrabold">
                  Traders Empowered
                </p>
              </div>
              <div className="space-y-1">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Why Choose Our <span className="text-indigo-500">Platform?</span>
            </h2>
            <p className="text-slate-400 max-w-xl mx-auto leading-relaxed">
              We provide comprehensive solutions tailored for institutional
              accuracy and retail simplicity.
            </p>
          </div>
        ...
        <div className="relative group overflow-hidden rounded-3xl bg-gradient-to-br from-[#0F172A] via-slate-900/40 to-indigo-950/30 border border-white/10 p-10 md:p-14 text-center backdrop-blur-xl transition-all duration-500 hover:border-indigo-500/30">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <h2 className="text-lg md:text-xl lg:text-2xl font-black italic tracking-tight leading-tight text-white/90">
              "Investing what's comfortable is rarely profitable. Our platform
              is designed to help you stay beyond comfort and into confidence."
            </h2>
            <div className="mt-8 flex items-center justify-center gap-4">
              ...
              />
              <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-indigo-500/60">
                PGR Strategic Vision
              </span>
              <motion.div
                initial={{ width: 0 }}
                whileInView={{ width: 40 }}
...
function AboutFeatureCard({
  ...
  return (
    ...
    >
      <Card className="p-10 rounded-3xl bg-gradient-to-b from-indigo-900/20 to-transparent border-indigo-500/30 flex flex-col items-center text-center group relative overflow-hidden hover:border-indigo-500/50 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-indigo-500/20 cursor-pointer w-full">
        {/* Glow Effect */}
        ...
        <CardContent className="p-0 relative z-10 w-full flex flex-col items-center">
          ...
          <h3 className="text-2xl font-bold mb-3 tracking-tight transition-colors group-hover:text-indigo-200">
            {title}
          </h3>
