          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <label className="text-xs font-semibold text-violet-400 tracking-wider uppercase ml-1">
                  New Access Key
                </label>
                  ...
                  <div className="space-y-1.5 pt-1">
                    <div className="flex gap-1 h-1">
                      {[1, 2, 3, 4].map((i) => (
                        <div
                          key={i}
                          className={`flex-1 rounded-full transition-all duration-300 ${strength >= i ? STRENGTH_COLORS[strength] : "bg-white/10"}`}
                        />
                      ))}
                    </div>
                    <p
                      className={`text-[10px] font-semibold ml-0.5 ${strength >= 4 ? "text-emerald-400" : strength >= 3 ? "text-yellow-400" : strength >= 2 ? "text-amber-500" : "text-red-400"}`}
                    >
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`relative w-full bg-[#0a0a16] border rounded-xl px-5 py-4 text-sm text-white font-mono placeholder:text-slate-600 focus:outline-none transition-all pr-12 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${
                      confirmPw
                        ? passwordsMatch
                ...
                {RULES.map((rule) => {
                  ...
                  return (
                    <div key={rule.id} className="flex items-center gap-2">
                      ...
                      <span
                        className={`text-xs transition-colors ${passed ? "text-emerald-400" : "text-slate-500"}`}
                      >
                        {rule.label}
                      </span>
                    </div>
              ...
              <div className="text-center pt-1">
                <a
                  href="/admin/staff-access-portal"
