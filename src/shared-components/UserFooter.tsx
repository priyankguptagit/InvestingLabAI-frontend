        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 mb-8">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-slate-400 leading-relaxed text-sm max-w-sm">
              The institutional standard for global research and algorithmic
              trading. Empowering investors with precision data and
            ...
            <div className="flex gap-3">
              ...
              <SocialIcon
                icon={Linkedin}
                href="https://linkedin.com/company/praedico"
              />
              <SocialIcon
                icon={Instagram}
                href="https://instagram.com/praedico"
              />
            </div>
          </div>
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-slate-400 text-sm mb-4 leading-relaxed">
              Subscribe to receive weekly macroeconomic insights and platform
